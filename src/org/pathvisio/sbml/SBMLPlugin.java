...
public class SBMLPlugin implements Plugin {
	...
	public void init(PvDesktop desktop) {
		...
		// add new Biomodels side pane
		BioModelPane bmpane = new BioModelPane(SBMLPlugin.this);
		JTabbedPane bmsidebarTabbedPane = desktop.getSideBarTabbedPane();
		bmsidebarTabbedPane.add("BioModels", bmpane);
		
		// add functionality to the panes
		desktop.getSwingEngine().getEngine().addApplicationEventListener(pane);
		//desktop.getSwingEngine().getEngine().addApplicationEventListener(bmpane);
		} 
		catch (Exception e) 
		{
